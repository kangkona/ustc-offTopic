...
def parse_options_set_disjunct_costf(*args):
  return _clinkgrammar.parse_options_set_disjunct_costf(*args)
parse_options_set_disjunct_costf = _clinkgrammar.parse_options_set_disjunct_costf

def parse_options_get_disjunct_costf(*args):
  return _clinkgrammar.parse_options_get_disjunct_costf(*args)
parse_options_get_disjunct_costf = _clinkgrammar.parse_options_get_disjunct_costf
...
def parse_options_set_use_fat_links(*args):
  return _clinkgrammar.parse_options_set_use_fat_links(*args)
parse_options_set_use_fat_links = _clinkgrammar.parse_options_set_use_fat_links

def parse_options_get_use_fat_links(*args):
  return _clinkgrammar.parse_options_get_use_fat_links(*args)
parse_options_get_use_fat_links = _clinkgrammar.parse_options_get_use_fat_links
...
def parse_options_set_use_cluster_disjuncts(*args):
  return _clinkgrammar.parse_options_set_use_cluster_disjuncts(*args)
parse_options_set_use_cluster_disjuncts = _clinkgrammar.parse_options_set_use_cluster_disjuncts

def parse_options_get_use_cluster_disjuncts(*args):
  return _clinkgrammar.parse_options_get_use_cluster_disjuncts(*args)
parse_options_get_use_cluster_disjuncts = _clinkgrammar.parse_options_get_use_cluster_disjuncts
...
def parse_options_set_batch_mode(*args):
  return _clinkgrammar.parse_options_set_batch_mode(*args)
parse_options_set_batch_mode = _clinkgrammar.parse_options_set_batch_mode

def parse_options_get_batch_mode(*args):
  return _clinkgrammar.parse_options_get_batch_mode(*args)
parse_options_get_batch_mode = _clinkgrammar.parse_options_get_batch_mode

def parse_options_set_panic_mode(*args):
  return _clinkgrammar.parse_options_set_panic_mode(*args)
parse_options_set_panic_mode = _clinkgrammar.parse_options_set_panic_mode

def parse_options_get_panic_mode(*args):
  return _clinkgrammar.parse_options_get_panic_mode(*args)
parse_options_get_panic_mode = _clinkgrammar.parse_options_get_panic_mode

def parse_options_set_display_on(*args):
  return _clinkgrammar.parse_options_set_display_on(*args)
parse_options_set_display_on = _clinkgrammar.parse_options_set_display_on

def parse_options_get_display_on(*args):
  return _clinkgrammar.parse_options_get_display_on(*args)
parse_options_get_display_on = _clinkgrammar.parse_options_get_display_on

def parse_options_set_display_postscript(*args):
  return _clinkgrammar.parse_options_set_display_postscript(*args)
parse_options_set_display_postscript = _clinkgrammar.parse_options_set_display_postscript

def parse_options_get_display_postscript(*args):
  return _clinkgrammar.parse_options_get_display_postscript(*args)
parse_options_get_display_postscript = _clinkgrammar.parse_options_get_display_postscript

def parse_options_set_display_constituents(*args):
  return _clinkgrammar.parse_options_set_display_constituents(*args)
parse_options_set_display_constituents = _clinkgrammar.parse_options_set_display_constituents

def parse_options_get_display_constituents(*args):
  return _clinkgrammar.parse_options_get_display_constituents(*args)
parse_options_get_display_constituents = _clinkgrammar.parse_options_get_display_constituents

def parse_options_set_display_bad(*args):
  return _clinkgrammar.parse_options_set_display_bad(*args)
parse_options_set_display_bad = _clinkgrammar.parse_options_set_display_bad

def parse_options_get_display_bad(*args):
  return _clinkgrammar.parse_options_get_display_bad(*args)
parse_options_get_display_bad = _clinkgrammar.parse_options_get_display_bad

def parse_options_set_display_disjuncts(*args):
  return _clinkgrammar.parse_options_set_display_disjuncts(*args)
parse_options_set_display_disjuncts = _clinkgrammar.parse_options_set_display_disjuncts

def parse_options_get_display_disjuncts(*args):
  return _clinkgrammar.parse_options_get_display_disjuncts(*args)
parse_options_get_display_disjuncts = _clinkgrammar.parse_options_get_display_disjuncts

def parse_options_set_display_links(*args):
  return _clinkgrammar.parse_options_set_display_links(*args)
parse_options_set_display_links = _clinkgrammar.parse_options_set_display_links

def parse_options_get_display_links(*args):
  return _clinkgrammar.parse_options_get_display_links(*args)
parse_options_get_display_links = _clinkgrammar.parse_options_get_display_links

def parse_options_set_display_senses(*args):
  return _clinkgrammar.parse_options_set_display_senses(*args)
parse_options_set_display_senses = _clinkgrammar.parse_options_set_display_senses

def parse_options_get_display_senses(*args):
  return _clinkgrammar.parse_options_get_display_senses(*args)
parse_options_get_display_senses = _clinkgrammar.parse_options_get_display_senses

def parse_options_set_display_union(*args):
  return _clinkgrammar.parse_options_set_display_union(*args)
parse_options_set_display_union = _clinkgrammar.parse_options_set_display_union

def parse_options_get_display_union(*args):
  return _clinkgrammar.parse_options_get_display_union(*args)
parse_options_get_display_union = _clinkgrammar.parse_options_get_display_union

def parse_options_set_echo_on(*args):
  return _clinkgrammar.parse_options_set_echo_on(*args)
parse_options_set_echo_on = _clinkgrammar.parse_options_set_echo_on

def parse_options_get_echo_on(*args):
  return _clinkgrammar.parse_options_get_echo_on(*args)
parse_options_get_echo_on = _clinkgrammar.parse_options_get_echo_on
...
def sentence_num_thin_linkages(*args):
  return _clinkgrammar.sentence_num_thin_linkages(*args)
sentence_num_thin_linkages = _clinkgrammar.sentence_num_thin_linkages
...
def sentence_contains_conjunction(*args):
  return _clinkgrammar.sentence_contains_conjunction(*args)
sentence_contains_conjunction = _clinkgrammar.sentence_contains_conjunction
...
def linkage_get_disjunct_str(*args):
  return _clinkgrammar.linkage_get_disjunct_str(*args)
linkage_get_disjunct_str = _clinkgrammar.linkage_get_disjunct_str

def linkage_get_disjunct_cost(*args):
  return _clinkgrammar.linkage_get_disjunct_cost(*args)
linkage_get_disjunct_cost = _clinkgrammar.linkage_get_disjunct_cost

def linkage_get_disjunct_corpus_score(*args):
  return _clinkgrammar.linkage_get_disjunct_corpus_score(*args)
linkage_get_disjunct_corpus_score = _clinkgrammar.linkage_get_disjunct_corpus_score
...
def linkage_free_disjuncts(*args):
  return _clinkgrammar.linkage_free_disjuncts(*args)
...
def linkage_is_fat(*args):
  return _clinkgrammar.linkage_is_fat(*args)
linkage_is_fat = _clinkgrammar.linkage_is_fat
